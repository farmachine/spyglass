...
def process_extraction_session(session_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for collection_name in collection_names:
        ...
        if aggregated_collection:
            ...
            # Note: Validation records will be created by the backend processing logic
            # We don't need to create them here since the backend will handle validation creation
            # for all extracted data during the session processing phase

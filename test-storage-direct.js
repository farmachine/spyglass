...
class DirectStorageTester {
  ...
  async initializeStorage() {
    try {
      ...
      this.log("✅ Storage module imported successfully");
      return true;
    } catch (error) {
  ...
  async setupTestData() {
    try {
      ...
      // For MemStorage, we need to manually add the test data
      if (this.storage.workflowSteps) {
        ...
        // For PostgreSQL storage, we'd need to use the actual DB methods
        this.log("⚠️ PostgreSQL storage detected - using alternative setup");
        // We'll need to use the actual create methods for PostgreSQL
      }
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = DirectStorageTester;
}

...
export const extractionSessions = pgTable("extraction_sessions", {
  ...
  inputTokens: integer("input_tokens"), // Number of input tokens used for AI extraction
  outputTokens: integer("output_tokens"), // Number of output tokens generated by AI
  createdAt: timestamp("created_at").defaultNow().notNull(),

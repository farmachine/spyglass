...
- **Centralized Prompt Management**: Implemented `all_prompts.py` for unified prompt control across the system. All AI prompts (document format analysis, extraction, validation, chat context) are now centrally managed for easy maintenance and consistency. Document format analysis prompt is the first implemented, allowing centralized control of Gemini document type classification.

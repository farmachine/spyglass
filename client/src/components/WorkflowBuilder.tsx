      ...
      <div className="flex flex-col items-center">
        ...
        {steps.map((step, stepIndex) => (
          <div key={step.id} className="flex flex-col items-center w-3/4">
            <Card className="relative w-full bg-white border-gray-600 shadow-sm hover:shadow-md transition-shadow">
        ...
        {steps.length === 0 ? (
          <>
            ...
            <Card className="p-12 w-3/4 bg-gray-50 border-gray-600">
...
function ValueEditor({
  ...
  return (
    <div className="border border-gray-600 rounded-lg p-4 space-y-3 bg-white relative">
      <div className="flex flex-col items-center">

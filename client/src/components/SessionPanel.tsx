...
import { MessageCircle, Bot, Clock, ChevronsRight } from "lucide-react";
...
export default function SessionPanel({ sessionId, session, validations, project, activeTab, onTabChange, onClose, onCollapse }: SessionPanelProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-900">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex-shrink-0">
        ...
        {/* Right side: tab icons + collapse chevron */}
        <div className="flex items-center gap-1">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-7 w-7 p-0 text-gray-400 hover:text-[#4F63A4] hover:bg-[#4F63A4]/10 ml-1"
